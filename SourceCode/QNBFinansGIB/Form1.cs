...
namespace QNBFinansGIB
{
    public partial class Form1 : Form
    {
        ...
        public string EFaturaXMLOlustur(GidenFaturaDTO gidenFatura, List<GidenFaturaDetayDTO> gidenFaturaDetayListesi, string aktarilacakKlasorAdi)
        {
            ...
            if (gidenFatura.KodSekerSatisTuruKod != null)
                kodSatisTuruKod = gidenFatura.KodSekerSatisTuruKod ?? 0;
            ...
            if (kodSatisTuruKod == SekerSatisTur.IhracKayitli.GetHashCode())
        ...
        public string EArsivXMLOlustur(GidenFaturaDTO gidenFatura, List<GidenFaturaDetayDTO> gidenFaturaDetayListesi, string aktarilacakKlasorAdi, bool tuzelKisiMi)
        {
            if (!tuzelKisiMi)
            {
